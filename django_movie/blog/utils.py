...
class ObjectDetailMixin:
    ...
    def get(self, reguest, slug):
        ...
        return render(reguest, self.template, context={self.model.__name__.lower(): obj, "admin_object": obj,
                                                       "detail": True})
...
class ObjectUpdateMixin:
    ...
    def get(self, reguest, slug):
        ...
        return render(reguest, self.template, context={"form": bound_form, self.model.__name__.lower(): obj})

    def post(self, reguest, slug):
        obj = self.model.objects.get(slug__iexact=slug)
        bound_form = self.model_form(reguest.POST, instance=obj)
